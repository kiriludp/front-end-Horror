const texts = [
    ...
    {
        id: 6,
        text: `Well… you’re pretty sure you were wrong. This does not seem like the way to camp. At all. Although, you have noticed that the trees have started to thin. That’s got to be a good sign right?
